...
**Version:** 1.1.3 · **License:** [BSD-3-Clause](LICENSE) · **Targets:** aarch64 (Jolla C2) and armv7hl
...
```bash
pkcon install-local harbour-casts-1.1.3-1.aarch64.rpm
# or on older 32-bit devices:
pkcon install-local harbour-casts-1.1.3-1.armv7hl.rpm
```
